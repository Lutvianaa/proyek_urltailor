...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <div class="row mt-3">
                <div class="col-md-3">
                    <div class="card text-white" style="background-color: #00969a;">
                        <div class="card-body mb-3">
                            <label for="">Pengguna</label>
                            <h1>{{ $jumlah1 }}</h1>
                        </div>
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a href="{{ url('datauser') }}" class="text-white">Selengkapnya >></a>
                ...
                <div class="col-md-3">
                    <div class="card text-white" style="background-color: #00969a;">
                        <div class="card-body mb-3">
                            ...
                            <h1>{{ $jumlah2 }}</h1>
                            <!-- <a href="{{ url('mitra') }}" class="text-white">view</a> -->
                        </div>
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a href="{{ url('mitra') }}" class="text-white">Selengkapnya >></a>
                            <div class="small text-white">
                                <i class="fas fa-angle-right"></i>    
                            </div>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="card text-white" style="background-color: #00969a;">
                        <div class="card-body mb-3">
                            ...
                            <h1>{{ $jumlah3 }}</h1>
                            <!-- <a href="{{ url('layanan') }}" class="text-white">view</a> -->
                        </div>
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a href="{{ url('layanan') }}" class="text-white">Selengkapnya >></a>
                            <div class="small text-white">
                                <i class="fas fa-angle-right"></i>    
                            </div>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="card text-white" style="background-color: #00969a;">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a data-bs-toggle="collapse" href="#collapseOne" class="text-white">Selengkapnya >></a>
                            <div class="small text-white">
                                <i class="fas fa-angle-right"></i>    
                            </div>                            
                        </div>
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
                                <div class="row">
                                    <ul>
                                        <li class="x-item mb-3">
                                            <a href="{{ url('star') }}">Star Tailoring</a>
                                        </li>
                                        <li class="x-item mb-3">
                                            <a href="{{ url('tailor') }}">Tailor</a>
                                        </li>
                                        <li class="x-item mb-3">
                                            <a href="{{ url('rumahjahit') }}">Rumah Jahit</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>    
