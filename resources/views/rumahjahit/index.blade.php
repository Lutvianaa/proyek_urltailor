...
<div class="container-fluid">
    ...
    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-custom">
        ...
        <div class="col py-3">
            ...
            <div class="card mt-3">
                <div class="card">
                    <div class="card-header">Testimoni Rumah Jahit</div>
                        <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
                            <div class="card-body">
                                <a href="{{ url('/rumahjahit/create') }}" class="btn btn-primary btn-sm mb-3" title="Add New Contact"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data
                                </a>
                                <div class="table-responsive px-4">
                                    <table class="table table-responsive table-bordered table-striped table-hover" id="example">      
                                        ...
                                        <tbody>
                                        @foreach($rumahjahit as $item)
                                            <tr>
                                                <td class="text-center">{{ $loop->iteration }}</td>
                                                <td>{{ $item->pelanggan }}</td>
                                                <td style ="width: 60%;">{{ $item->testimoni }}</td>
                                                <td class="text-center">
                                                    <button class="btn btn-primary btn-sm"><a href="{{ route('rumahjahit.edit', $item->id) }}" data-toggle="tooltip" title="Edit Data!"><i class="fa fa-edit text-white"></i></a></button>
                                                    <form action="{{ route('rumahjahit.destroy', $item->id) }}" method="POST" style="display: inline">
                                                        {!! csrf_field() !!}
                                                        {!! method_field('DELETE') !!}
