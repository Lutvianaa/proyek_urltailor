                ...
                <div class="card">
                    <div class="card-header">Data Layanan</div>
                        <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
                            <div class="card-body">
                                <a href="{{ url('/layanan/create') }}" class="btn btn-primary btn-sm mb-3" title="Add New Contact"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data
                                </a>
                                    ...
                                    <table class="table table-responsive table-bordered table-striped table-hover" id="example">      
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style ="width: 12%;">{{ $item->mitra }}</td>
                                                <td style ="width: 45%;">{{$item->deskripsi}}</td>
                                                <td>
                                                    <img src="{{ asset($item->foto) }}" width= '50' height='50' class="img img-responsive" />
                                                </td>
                                                <td class="text-center">
                                                    <button class="btn btn-primary btn-sm"><a href="{{ route('layanan.edit', $item->id) }}" data-toggle="tooltip" title="Edit Data!"><i class="fa fa-edit text-white"></i></a></button>
