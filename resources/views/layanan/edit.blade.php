...
<div class="card" style="margin: 20px;">
    <div class="card-header">Edit Data Layanan</div>
    <div class="card-body">
        ...
        <form action="{{ route('layanan.update', $layanan->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-4">
                <label class="form-control-label" for="layanan">Layanan</label><br>
                <input type="text" name="layanan" id="layanan" class="form-control" value="{{ $layanan->layanan }}">
            </div>
            <div class="form-group mb-4">
                <label class="form-control-label" for="mitra">Mitra</label><br>
                <input type="text" name="mitra" id="mitra" class="form-control" value="{{ $layanan->mitra }}">
            </div>
            <div class="form-group mb-4">
                <label class="form-control-label" for="deskripsi">Deskripsi</label><br>
                <input type="text" name="deskripsi" id="deskripsi" class="form-control" value="{{ $layanan->deskripsi }}">
            </div>
            <div class="form-group mb-4">
                <label class="form-control-label">Foto</label><br>
                <input class="form-control" name="foto" type="file" id="foto"><br>
                <img src="{{ asset($layanan->foto) }}" width="50" height="50" class="img img-responsive" />
            </div>
