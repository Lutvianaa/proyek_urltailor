...
<div class="card" style="margin: 20px;">
  <div class="card-header">Tambah Data Layanan</div>
  <div class="card-body">
      ...
      <form action="{{ url('layanan') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="layanan" id="layanan" class="form-control"></br>
        </div>
        <div class="form-group">
          <label class="form-control-label" for="mitra">Mitra</label></br>
          <input type="text" name="mitra" id="mitra" class="form-control"></br>
        </div>
        <div class="form-group">
        ...
        <div class="col-12 save-btm save-button justify-content-center d-flex">          
