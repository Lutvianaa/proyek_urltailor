    ...
    <div class="card-body">
        ...
        <form action="{{ route('star.update', $star->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="pelanggan" id="pelanggan" class="form-control" value="{{ $star->pelanggan }}">
            </div>
            <div class="form-group mb-4">
                <label class="form-control-label" for="testimoni">Testimoni</label><br>
                <input type="text" name="testimoni" id="testimoni" class="form-control" value="{{ $star->testimoni }}">
            </div>
