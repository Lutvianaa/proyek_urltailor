...
<div class="container-fluid">
    ...
    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-custom">
        ...
        <div class="col py-3">
            ...
            <div class="card mt-3">
                <div class="card">
                    <div class="card-header">Testimoni Tailor</div>
                        <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
                            <div class="card-body">
                                <a href="{{ url('/tailor/create') }}" class="btn btn-primary btn-sm mb-3" title="Add New Contact"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data
                                </a>
                                        ...
                                        @foreach($tailor as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-primary btn-sm"><a href="{{ route('tailor.edit', $item->id) }}" data-toggle="tooltip" title="Edit Data!"><i class="fa fa-edit text-white"></i></a></button>
                                                    <form action="{{ route('tailor.destroy', $item->id) }}" method="POST" style="display: inline">
                                                        {!! csrf_field() !!}
                                                        {!! method_field('DELETE') !!}
