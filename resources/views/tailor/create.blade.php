...
<div class="card" style="margin: 20px;">
  <div class="card-header">Tambah Data Testimoni</div>
  <div class="card-body">
       
      <form action="{{ url('tailor') }}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="form-group">
          <label class="form-control-label" for="pelanggan">Nama Pelanggan</label></br>
          <input type="text" name="pelanggan" id="pelanggan" class="form-control"></br>
        </div>
        <div class="form-group">
          <label class="form-control-label" for="testimoni">Testimoni</label></br>
          <input type="text" name="testimoni" id="testimoni" class="form-control"></br>
        </div>
