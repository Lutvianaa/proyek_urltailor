...
<div class="card" style="margin: 20px;">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('tailor.update', $tailor->id) }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            {!! method_field('PUT') !!}

            <div class="form-group mb-4">
                <label class="form-control-label" for="pelanggan">Nama Pelanggan</label><br>
                <input type="text" name="pelanggan" id="pelanggan" class="form-control" value="{{ $tailor->pelanggan }}">
            </div>
            <div class="form-group mb-4">
                <label class="form-control-label" for="testimoni">Testimoni</label><br>
                <input type="text" name="testimoni" id="testimoni" class="form-control" value="{{ $tailor->testimoni }}">
            </div>
