    ...
    <div class="card-body">
        ...
        <form action="{{ route('mitra.update', $mitra->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="nama" id="nama" class="form-control" value="{{ $mitra->nama }}">
            </div>
            <div class="form-group mb-4">
                <label class="form-control-label" for="alamat">Alamat</label><br>
                <input type="text" name="alamat" id="alamat" class="form-control" value="{{ $mitra->alamat }}">
            </div>
            <div class="form-group mb-4">
                <label class="form-control-label" for="no_telepon">Nomor Telepon</label><br>
                <input type="text" name="no_telepon" id="no_telepon" class="form-control" value="{{ $mitra->no_telepon }}">
            </div>
            <div class="form-group mb-4">
                <label class="form-control-label">Logo</label><br>
                <input class="form-control" name="logo" type="file" id="logo"><br>
                <img src="{{ asset($mitra->logo) }}" width="150" height="50" class="img img-responsive" />
            </div>
